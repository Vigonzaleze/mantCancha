    ...
    <section>
        <div align="center">
            <div align="center" style="padding-top: 5%;height:100vh; background-color: #95A3B3; border-radius: 0.5%" >
                ...
                <hr>
                <a href="{{URL::route('mantDirs')}}" class="btn btn-primary btn-dark" role="button">Volver</a>
                <hr>
                <form action="{{URL::route('agregarDir')}}" method="post">
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            <label for="">Calle</label>
                            <input type="text" name="txtCalle" id="txtCalle" required class="form-control"> 
                        </div>
                        <div class="form-group col-md-6">
                            <label for="">Numeracion</label>
                            <input type="number" name="nmbNumeracion" id="nmbNumeracion" required class="form-control">
                        </div>
                    </div>
